...
class HTTPProvider(object):
    ...
    :params endpoint_uri: HTTP API URL base. Can also be configured via
        the ``TPRPY_HTTP_PROVIDER_URI`` environment variable.
    """
    ...
    def __init__(self, endpoint_uri: Union[str, dict] = None, timeout: float = DEFAULT_TIMEOUT):
        ...
        if endpoint_uri is None:
            self.endpoint_uri = os.environ.get("TPRPY_HTTP_PROVIDER_URI", "")
        ...
        self.sess.headers["User-Agent"] = "Tprpy/0.0.1"
