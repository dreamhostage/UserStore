...
from tprpy.exceptions import DoubleSpending
from tprpy.abi import trx_abi
import tprpy
...
class Contract(object):
    ...
    def update_user_resource_percent(self, percent: int) -> "tprpy.tpr.TransactionBuilder":
    ...
    def update_origin_energy_limit(self, limit: int) -> "tprpy.tpr.TransactionBuilder":
    ...
    def clear_abi(self) -> "tprpy.tpr.TransactionBuilder":
        """Clear contract ABI."""
        if self.origin_address != self.owner_address:
            raise RuntimeError("origin address and owner address mismatch")
...
class ContractMethod(object):
    ...
    def with_owner(self, addr: str) -> "ContractMethod":
        ...
        Can also be changed through :meth:`TransactionBuilder.with_owner() <tprpy.tpr.TransactionBuilder.with_owner>`.
        """
    ...
    def call(self, *args, **kwargs) -> "tprpy.tpr.TransactionBuilder":
    ...
    def __call__(self, *args, **kwargs) -> "tprpy.tpr.TransactionBuilder":
        """Call the contract method."""
        parameter = ""
...
class ShieldedTRC20(object):
    ...
    def mint(self, taddr: str, zaddr: str, amount: int, memo: str = "") -> "tprpy.tpr.TransactionBuilder":
